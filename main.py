...
class MainClass(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.wm_title("Smart Security System")
        self.wm_geometry("650x550+300+100")
        ...
        for F in (
                StartPage, Login, SignUp, Registration, AttendanceEmployee, SecondPage, ThirdPage, Employee,
                Show_Employee,
                Developers, Email):
...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        Label(self, text="Welcome to Smart Security System",
        ...
        Label(self,
              ...
              font=("Times New Roman", 15, 'bold'), bg="black", fg="white").place(x=0, y=515)

        conn = sqlite3.connect("Registration.db")
        c = conn.cursor()
        c.execute(
            "CREATE TABLE IF NOT EXISTS employee(id integer unique primary key autoincrement, employee_name TEXT, employee_id TEXT, employee_department, employee_email TEXT)")
        c.execute(
            "CREATE TABLE IF NOT EXISTS all_record(id integer unique primary key autoincrement, employee_name TEXT, employee_id TEXT, employee_department, employee_status TEXT, attendance_date TEXT, attendance_time TEXT)")
        c.execute(
            'CREATE TABLE IF NOT EXISTS Login(id integer unique primary key autoincrement, Username TEXT, Password TEXT)')
        c.execute(
            "CREATE TABLE IF NOT EXISTS present_record(employee_name TEXT, employee_id TEXT, employee_department TEXT, employee_status TEXT, attendance_date TEXT,attendance_time TEXT)");
        c.execute(
            "CREATE TABLE IF NOT EXISTS Signup(id integer unique primary key autoincrement, frist_name TEXT, last_name TEXT, Username TEXT)")
        c.execute(
            'CREATE TABLE IF NOT EXISTS Login(id integer unique primary key autoincrement, Username TEXT, Password TEXT)')
...
class SecondPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        l.image = photo
        l.pack()
        Label(self, text="Admin Username", font=("Times new Roman", 14, 'bold'), bg='black', fg='white').place(x=100,
                                                                                                               y=70)
        admin_user = StringVar()
        admin_name = ttk.Entry(self, width=20, textvariable=admin_user)
        admin_name.place(x=260, y=76)

        Label(self, text="Admin Password", font=("Times New Roman", 14, 'bold'), bg='black', fg='white').place(x=100,
                                                                                                               y=100)
        ...
        def checker():
            ...
            if admin_name_error == "":
                ...
                messagebox.showerror("Error", "Please Fill The Fields First")
            elif admin_name_error == "com" and admin_pass_error == "comsats":
...
class ThirdPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        btn_signUp = ttk.Button(self, text="Add User", command=lambda: controller.show_frame(SignUp))
...
class AttendanceEmployee(tk.Frame):
    ...
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        Label(self, text="HOME SCREEN", font=("Times New Roman", 20, 'bold'), bg="black", fg="white").pack(fill="x")
        photo = PhotoImage(file='img1.png')
        l = Label(self, image=photo)
        l.image = photo
        l.pack()
        btn_emp_reg = ttk.Button(self, text="Register Employee", width=20,
                                 command=lambda: controller.show_frame(Registration)).place(x=490, y=50, width=150,
                                                                                            height=40)
        btn_train = ttk.Button(self, text="Train Model", width=20, command=lambda: trainer()).place(x=490, y=110,
                                                                                                    width=150,
                                                                                                    height=40)
        btn_attendance = ttk.Button(self, text="Mark Attendance", width=20, command=lambda: recognizer()).place(x=490,
                                                                                                                y=170,
                                                                                                                width=150,
                                                                                                                height=40)
        btn_list = ttk.Button(self, text="Employee List", width=20,
                              command=lambda: controller.show_frame(Employee)).place(x=490, y=230, width=150, height=40)
        btn_show_employee = ttk.Button(self, text="Show Attendance", width=20,
                                       command=lambda: controller.show_frame(Show_Employee)).place(x=490, y=290,
                                                                                                   width=150, height=40)
        btn_show_employee = ttk.Button(self, text="Save To Cloud (FireBase)", width=20, command=lambda: cloud()).place(
            x=490, y=350, width=150, height=40)
        btn_show_employee = ttk.Button(self, text="Send Email", width=20,
                                       command=lambda: controller.show_frame(Email)).place(x=490, y=410, width=150,
                                                                                           height=40)
        btn_show_employee = ttk.Button(self, text="About Developers", width=20,
                                       command=lambda: controller.show_frame(Developers)).place(x=490, y=470, width=150,
                                                                                                height=40)
        Label(self,
              text="                                                Smart Security System                                                ",
              font=("Times New Roman", 15, 'bold'), bg="black", fg="white").place(x=0, y=515)
        ...
        def cloud():
            try:
                ...
                s.close()
                filename = filedialog.askopenfilename(initialdir='./Attendance', title='Select a file',
                                                      filetype=(("csv", "*.xlsx"), ("All files", "*.*")))
                config = {
                    ...
                    "apiKey": "AIzaSyA2aitBFNoLpIjhNr2NK0ugAwuUoyJk518",
                    "authDomain": "smartsecurity-ecdb3.firebaseapp.com",
                    "projectId": "smartsecurity-ecdb3",
                    "storageBucket": "smartsecurity-ecdb3.appspot.com",
                    "messagingSenderId": "548567935546",
                    "appId": "1:548567935546:web:d93e44cb5396f034186303",
                    "measurementId": "G-NRT9NH9W1G"
        ...
        def recognizer():
            ...
            while True:
                ...
                for (x, y, w, h) in faces:
                    ...
                    if conf < 70:
                        cv2.putText(img, employee_name, (x + 5, y + h - 12), cv2.FONT_HERSHEY_SIMPLEX, 1, (150, 255, 0),
                                    2)
                        ...
                        c.execute(
                            'SELECT * FROM present_record WHERE employee_id = (?) AND attendance_date = CURRENT_DATE;',
                            (id_emp,))
                        rzlt = c.fetchall()
                        if len(rzlt) > 0:
                            cap.release()
                            ...
                            if len(i) == 0:
                                c.execute(
                                    "INSERT INTO all_record(employee_name, employee_id, employee_department) SELECT employee_name, employee_id, employee_department FROM employee")
                                c.execute(
                                    "UPDATE all_record SET attendance_date = :attend_date WHERE attendance_date IS NULL",
                                    {'attend_date': date_now})
                                conn.commit()
                                ...
                                if len(i) > 0:
                                    ...
                                    if len(x) == 0:
                                        c.execute(
                                            "INSERT INTO all_record(employee_name, employee_id, employee_department, attendance_date) VALUES (?,?,?,?)",
                                            (name_emp, id_emp, dept_emp, date_now))

                                c.execute(
                                    "INSERT INTO present_record(employee_name, employee_id, employee_department,employee_status, attendance_date, attendance_time) VALUES(?,?,?,?,?,?)",
                                    (name_emp, id_emp, dept_emp, status_emp, date_now, time_now))
                                c.execute(
                                    "UPDATE all_record SET employee_status = 'ABSENT' WHERE NOT employee_id = :emp_rec_id AND employee_status IS NULL",
                                    {'emp_rec_id': id_emp})
                                c.execute(
                                    "UPDATE all_record SET attendance_time  = 'N/A' WHERE NOT employee_id = :emp_rec_id AND attendance_time  IS NULL",
                                    {'emp_rec_id': id_emp})
                                c.execute(
                                    "UPDATE all_record SET attendance_date = :attend_date WHERE attendance_date IS NULL",
                                    {'attend_date': date_now})
                                ...
                                c.execute(
                                    "UPDATE all_record SET employee_status = 'PRESENT' WHERE (employee_id = :emp_rec_id AND attendance_date = :attend_date) AND ((employee_status = 'ABSENT') OR (employee_status IS NULL))",
                                    {'emp_rec_id': id_emp, 'attend_date': date_now})
                                ...
                                c.execute(
                                    "UPDATE all_record SET attendance_time  = :attend_time WHERE employee_id = :emp_rec_id AND attendance_time = 'N/A' OR attendance_time IS NULL",
                                    {'emp_rec_id': id_emp, 'attend_time': time_now})
                                messagebox.showinfo("Success",
                                                    "Attendance of employee " + name_emp + " is Marked Successfully!")
                                playsound('./sound.mp3')
                                conn.commit()
                                ...
                                try:
                                    ...
                                    sender_email = 'numair481@gmail.com'
                                    sender_password = 'ca1234567891'
                                    ...
                                    server.quit()
                                    messagebox.showinfo("Success",
                                                        "Attendance Marked And Mail is Successfully Sent To The Employee")
                                except:
                                    messagebox.showerror("Error",
                                                         "Attendance Marked But Email Doesn't Sent Because Something Went Wrong")
                        ...
                        try:
                            ...
                            data = pd.DataFrame(attendance_of_employee,
                                                columns=['Employee Name', 'Employee ID', 'Employee Department',
                                                         'Attendance', 'Date', 'Time'])
                            datatoexcel = pd.ExcelWriter("Attendance/Employee Attendance " + today + ".xlsx",
                                                         engine='xlsxwriter')
...
class Registration(tk.Frame):
    ...
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        Label(self, text="Register Employee", font=("Times New Roman", 20, 'bold'), bg="black", fg="white").pack(
            fill="x")
        photo = PhotoImage(file='img1.png')
        l = Label(self, image=photo)
        l.image = photo
        l.pack()
        Label(self, text="Employee Name", font=("Times new Roman", 12, 'bold'), bg="black", fg="white").place(x=150,
                                                                                                              y=70)
        user_emp = StringVar()
        ...
        Label(self, text="Employee ID", font=("Times New Roman", 12, 'bold'), bg="black", fg="white").place(x=150,
                                                                                                            y=100)
        ...
        Label(self, text="Employee Department", font=("Times New Roman", 12, 'bold'), bg="black", fg="white").place(
            x=110, y=130)
        emp_depart = StringVar()
        emp_dep = ttk.Combobox(self, width=17, textvariable=emp_depart, font=("Times New Roman", 10), state='readonly')
        emp_dep['values'] = ("CS", "MECHANICAL", 'ELECTRICAL', 'CIVIL', 'BBA',
                             'MA(English)', 'MA(Education)', 'Zology', 'Botany')
        emp_dep.place(x=270, y=130)

        Label(self, text="Employee Email", font=("Times New Roman", 12, 'bold'), bg="black", fg="white").place(x=150,
                                                                                                               y=160)
        ...
        self.btn_img = ImageTk.PhotoImage(file="back.png")
        btn_back = Button(self, image=self.btn_img, cursor="hand2", borderwidth=0,
                          command=lambda: controller.show_frame(AttendanceEmployee))
        ...
        def save_emp():
            ...
            if emp_user_error == "":
                ...
                c = conn.cursor()
                c.execute(
                    'INSERT INTO employee (employee_name, employee_id, employee_department, employee_email) VALUES (?,?,?,?)',
                ...
                while (True):
                    ...
                    for (x, y, w, h) in faces:
                        ...
                        cv2.imwrite("dataset/" + name + "." + str(max_id) + "." + str(count) + ".jpg",
                                    gray[y:y + h, x:x + w])
...
class SignUp(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        conn = sqlite3.connect("Registration.db")
        c = conn.cursor()
        Label(self, text="Add User", font=("Times New Roman", 20, 'bold'), bg="black", fg="white").pack(fill=X)
        photo = PhotoImage(file='img1.png')
        l = Label(self, image=photo)
        l.image = photo
        l.pack()
        ...
        Label(self, text="Confirm Password", font=("Times New Roman", 12, 'bold'), bg="black", fg="white").place(x=100,
                                                                                                                 y=190)
        ...
        btn_sign = ttk.Button(self, text="Add User", command=lambda: save())
        ...
        def save():
            ...
            if fname_error == "":
                ...
                c.execute("INSERT INTO Signup(frist_name, last_name, Username) VALUES (?,?,?)",
                          (fname_var.get(), lname_var.get(), usr_var.get()))
    ...
    def __init__(self, parent, controller):
        ...
        def xlsx():
            ...
            if counter == 0:
                ...
                data = pd.DataFrame(data_employee, columns=['ID', 'Employee Name', 'Employee ID', 'Employee Department',
                                                            'Employee Email'])
                datatoexcel = pd.ExcelWriter("Employee Data Excel/Employee List " + today + ".xlsx",
                                             engine='xlsxwriter')
                data.to_excel(datatoexcel, index=False, sheet_name="Sheet")
                worksheet = datatoexcel.sheets['Sheet']
                worksheet.set_column('A:A', 25)
        ...
        def update():
            ...
            try:
                ...
                frame = Frame(top)
                Label(top, text="Update Data", font=("Times New Roman", 20, 'bold'), bg="black", fg="white").pack(
                    fill="x")
                ...
                btn_update = ttk.Button(top, width=12, text="Update",
                                        command=lambda: update_record(old_name, old_email, new_value_name.get(),
                                                                      new_value_email.get()))
                btn_update.pack()
                frame.pack()
                ...
                def update_record(name, email, new_name, new_email):
                    ...
                    if new_name == "":
                        ...
                        conn = sqlite3.connect("Registration.db")
                        c = conn.cursor()
                        c.execute('UPDATE employee SET employee_name = :new_name WHERE employee_name = :name',
                                  {'name': name, "new_name": new_name})
                        c.execute('UPDATE all_record SET employee_name = :new_name WHERE employee_name = :name',
                                  {'name': name, "new_name": new_name})
                        c.execute('UPDATE employee SET employee_email = :new_email WHERE employee_email = :email',
                                  {'email': email, "new_email": new_email})
                        conn.commit()
...
class Show_Employee(tk.Frame):
    ...
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        Label(self, text="Employee History", font=("Times New Roman", 20, 'bold'), bg="black", fg="white").pack(fill=X)
        photo = PhotoImage(file='img1.png')
        l = Label(self, image=photo)
        l.image = photo
        l.pack()
        Label(self, text="Seach Employee By Entering Employee ID", font=("Times New Roman", 10, 'bold'), bg="black",
        ...
        Label(self, text="Seach Employee By Entering Date as YYYY-MM-DD", font=("Times New Roman", 10, 'bold'),
              bg="black", fg="white").place(x=5, y=150)
                ...
                if str(id_error) == '' and str(date_error) == '':
                    ...
                    if id_error != 0:
                        ...
                        if len(resultss_id) != 0:
                            try:
                                j = str(i)
                                data = pd.DataFrame(resultss_id, columns=['ID', 'Employee Name', 'Employee ID',
                                                                          'Employee Department', 'Attendance', 'Date',
                                                                          'Time'])
                                datatoexcel = pd.ExcelWriter(
                                    "Saved Employee Attendance Excel/Employee List " + today + "(" + j + ").xlsx",
                                    engine='xlsxwriter')
                                data.to_excel(datatoexcel, index=False, sheet_name="Sheet")
                                worksheet = datatoexcel.sheets['Sheet']
                                ...
                                datatoexcel.save()
                                messagebox.showinfo("Success",
                                                    "Excel File is Generated Successfully Employee List " + today + "(" + j + ").xlsx")
                            except:
                    ...
                    if date_another_error == '':
                        ...
                        if len(results_data) != 0:
                            try:
                                data = pd.DataFrame(results_data, columns=['ID', 'Employee Name', 'Employee ID',
                                                                           'Employee Department', 'Attendance', 'Date',
                                                                           'Time'])
                                datatoexcel = pd.ExcelWriter(
                                    "Saved Employee Attendance Excel/Employee List " + today + "(" + str(i) + ").xlsx",
                                    engine='xlsxwriter')
                                data.to_excel(datatoexcel, index=False, sheet_name="Sheet")
                                worksheet = datatoexcel.sheets['Sheet']
                                worksheet.set_column('A:A', 15)
                                ...
                                datatoexcel.save()
                                messagebox.showinfo("Success",
                                                    "Excel File is Generated Successfully Employee List " + today + "(" + str(
                                                        i) + ").xlsx")
                            except:
                        ...
                        if len(resultss_id) != 0:
                            try:
                                pdf = SimpleDocTemplate(
                                    "./Saved Employee Attendance PDF/Employee List " + today + "(" + str(i) + ").pdf")
                                flow_obj = []
                                td = [['ID', 'Employee Name', 'Employee ID', "Employee Department", "Employee Status",
                                ...
                                pdf.build(flow_obj)
                                messagebox.showinfo("Success",
                                                    "PDF generated Successfully With This Name Employee List " + today + "(" + str(
                                                        i) + ").pdf")
                            except:
                                messagebox.showerror("Error", "Invalid Id Or Record Does Not Exists")
        ...
        def percent():
            try:
                ...
                frame = Frame(top)
                Label(top, text="Calculate Percentage", font=("Times New Roman", 20, 'bold'), bg="black",
                ...
                btn_update = ttk.Button(top, width=20, text="Calculate Percentage",
                                        command=lambda: calc(from_date_.get(), to_date_.get()))
                btn_update.pack()
                frame.pack()
                    ...
                    if from_ == "":
                        ...
                        if to_ != "":
                            try:
                                ...
                                conn = sqlite3.connect("Registration.db")
                                c = conn.cursor()
                                c.execute("SELECT * FROM all_record WHERE attendance_date = (?) AND employee_id = (?)",
                                          (from_date_val, emp_id,))
                                ...
                                if len(from_rzlt) == 0:
                                    ...
                                    c.execute(
                                        "SELECT * FROM all_record WHERE attendance_date BETWEEN (?) AND (?) AND employee_id = (?)",
                                        (from_date_val, to_date_val, emp_id,))
                                    total_rzlt = c.fetchall()
                                    c.execute(
                                        'SELECT * FROM all_record WHERE attendance_date BETWEEN (?) AND (?) AND employee_id = (?) AND employee_status = "PRESENT" ',
                                        (from_date_val, to_date_val, emp_id,))
                                    present_rzlt = c.fetchall()
                                    c.execute(
                                        'SELECT * FROM all_record WHERE attendance_date BETWEEN (?) AND (?) AND employee_id = (?) AND employee_status = "ABSENT" ',
                                        (from_date_val, to_date_val, emp_id,))
                                    ...
                                    data_of_employee = [emp_name, emp_id_, emp_dpt, present_percentage,
                                                        absnet_percentage, from_date_val, to_date_val]
                                    if not os.path.exists('./Employee Attendance Percentage'):
                                        os.makedirs('./Employee Attendance Percentage')
                                    data = pd.DataFrame([data_of_employee],
                                                        columns=['Employee Name', 'Employee ID', 'Employee Department',
                                                                 'Present Percentage', 'Absent Percentage',
                                                                 'From This Date', 'To This Date'])
                                    datatoexcel = pd.ExcelWriter(
                                        "Employee Attendance Percentage/Employee " + str(emp_name) + "(" + str(
                                            rand) + ").xlsx", engine='xlsxwriter')
                                    data.to_excel(datatoexcel, index=False, sheet_name="Sheet")
                                    worksheet = datatoexcel.sheets['Sheet']
                                    worksheet.set_column('A:A', 25)
                                    ...
                                    datatoexcel.save()
                                    messagebox.showinfo("Success",
                                                        "Excel File is Generated Successfully Employee " + str(
                                                            emp_name) + "(" + str(rand) + ").xlsx")
...
class Email(tk.Frame):
    ...
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        Label(self, text="Send Emails To Employee", font=("Times New Roman", 20, 'bold'), bg="black", fg="white").pack(
            fill=X)
        ...
        Label(self, text="Employee's Email Address", font=("Times New Roman", 12, 'bold'), bg="black",
              fg="white").place(x=50, y=80)

        email_address_var = StringVar()
        email_address = ttk.Combobox(self, width=40, textvariable=email_address_var, font=("Times New Roman", 10),
                                     state='readonly')
        email_address['values'] = resultss
        email_address.place(x=270, y=80)

        Label(self, text="Email's Content", font=("Times New Roman", 20, 'bold'), bg="black", fg="white").place(x=50,
                                                                                                                y=110)
        ...
        def send_email():
            ...
            if len(email_address_error) == 0:
                ...
                try:
                    ...
                    sender_password = 'ca1234567891'
                    server = smtplib.SMTP('smtp.gmail.com', 25)
                    message = 'Subject: Smart Security System \n{}'.format(email_error)
                    server.ehlo()
                    server.starttls()
                    server.login(sender_email, sender_password)
